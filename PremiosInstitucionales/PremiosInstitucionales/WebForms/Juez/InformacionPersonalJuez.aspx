<%@ Page Title="" Language="C#" MasterPageFile="~/MP-Global.Master" AutoEventWireup="true" CodeBehind="InformacionPersonalJuez.aspx.cs" Inherits="PremiosInstitucionales.WebForms.InformacionPersonalJuez" EnableEventValidation="false"%>
                ...
                <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                    <div class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <asp:TextBox ID="NombresTextBox" runat="server" class="form-control" type="text"  maxlength='20'/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Apellido(s):</label>
                            <div class="col-lg-8">
                                <asp:TextBox ID="ApellidosTextBox" runat="server" class="form-control" type="text" maxlength='20'/>
                            </div>
                        </div>
                        <div class="form-group">
